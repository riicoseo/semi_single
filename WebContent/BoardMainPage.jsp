...
<body>
	...
	<div class ="container">
		...
		<div class="row">
			...
			<tbody>
				<tr>
					<td class="d-sm-table-cell">1</th>
					<td class="d-sm-table-cell">가입인사 드려요</th>
					<td class="d-sm-table-cell">아이언맨</th>
					<td class="d-none d-md-table-cell ">2021.06.23</th>
					<td class="d-none d-md-table-cell ">5</th>
				</tr>	
				<tr>
					<td class="d-sm-table-cell">2</th>
					<td class="d-sm-table-cell">가입인사 드려요</th>
					<td class="d-sm-table-cell">아이언맨</th>
					<td class="d-none d-md-table-cell ">2021.06.23</th>
					<td class="d-none d-md-table-cell ">5</th>
